...
/**
 * print_osabi_more - check the code
 * @h: is a parameter
 * Return: Always 0.
 */
void print_osabi_more(Elf64_Ehdr h)
...
/**
 * print_abiversion - check the code
 * @h: is a parameter
 * Return: Always 0.
 */
